                                 ...
                                 <div className="DebitAgreementDetail mb-2" ref={DownloadForm} style={{minWidth:'1000px'}}>
                                    <div className=" table-responsive">
                                        <table class="table table-white table-borderless">
                                            <tbody>
                                                <tr>
                                                    <td colSpan={3} className="text-center text-purpal"><h5>&nbsp; Delivery Tickets</h5></td>
                                                </tr>
                                                <tr>
                                                    <td className="text-red text-purpal w-30" style={{width:'40%;'}}>Delivey Manifest #1957</td>
                                         ...
                                         <table class="table table-white table-bordered pageBreak" style={{background:'#fff', marginBlockEnd:'30px'}}>
                                            <thead>
                                                 <tr>
                                                     <th>
                                                         <h3 className="transportNumber" style={{marginBlockEnd:'0', fontSize:'24px', padding:'10'}}> 1. Marche Stephane Beaulieu inc. #1282</h3>
                                                     </th>
                                                </tr>
                                             </thead>
                                             <tbody>
                                                 <tr>
                                                     <td colSpan={3} style={{borderBottom:'1px solid #9370DB'}}>
                                                         <h5 style={{ fontSize: '17px', paddingInlineStart: '15px', margin: '0' }}>
                                                             1535 route 125 <br/>
                                                             Sainte - Julienne JOK 2TO QC
                                                         </h5>
                                                     </td>
                                                 </tr>
                                                 <tr>
                                        ...
                                        <table class="table table-white table-bordered pageBreak" style={{background:'#fff', marginBlockEnd:'30px'}}>
                                            <thead>
                                                 <tr>
                                                     <th>
                                                         <h3 className="transportNumber" style={{marginBlockEnd:'0', fontSize:'24px', padding:'10'}}> 2. Marche Stephane Beaulieu inc. #1282</h3>
                                                     </th>
                                                </tr>
                                             </thead>
                                             <tbody>
                                         ...
                                         <table class="table table-white table-bordered pageBreak" style={{background:'#fff',  marginBlockEnd:'30px'}}>
                                            <thead>
                                                 <tr>
                                                     <th>
                                                         <h3 className="transportNumber" style={{marginBlockEnd:'0', fontSize:'24px', padding:'10'}}> 3. Marche Stephane Beaulieu inc. #1282</h3>
                                                     </th>
                                                </tr>
                                             </thead>
                                             <tbody>
