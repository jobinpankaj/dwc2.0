                            ...
                            <div class="contentBx">
                                <div className="clear">
                                    <div className="teamImg">
                                        <img src={raph} class="card-img-top circle" alt="Raphael Ethier" />
                                    </div>
                                    <h3 className="mb-2 text-purpal"> Raphael Ethier </h3>
                                    <h6 className="mb-4 degignation">{t('landing.raphael.position')}</h6>
                                    <p>{t('landing.raphael.p1')} </p>
                                    <p>{t('landing.raphael.p2')}</p>
                                    <p>{t('landing.raphael.p3')}</p>
                                    <p>{t('landing.raphael.p4')}</p>
                                    <p>{t('landing.raphael.p5')}</p>
                                    <p>{t('landing.raphael.p6')}</p>
                                    <p>{t('landing.raphael.p7')} </p>
                                </div>
...
export default RaphaelEthierPage;