                            ...
                            <div class="contentBx">
                                <div className="clear">
                                    <div className="teamImg">
                                        <img src={PhilippeWouters} class="card-img-top circle" alt="Philippe Wouters" />
                                    </div>
                                    <h3 className="mb-2 text-purpal"> Phileppe Wouters </h3>
                                    <h6 className="mb-4 degignation">{t('landing.phileppe.position')}</h6>
                                    <p>{t('landing.phileppe.p1')} </p>
                                    <p>{t('landing.phileppe.p2')} </p>
                                    <p>{t('landing.phileppe.p3')}</p>
                                    <p>{t('landing.phileppe.p4')}</p>
                                </div>
...
export default PhileppeWoutersPage;