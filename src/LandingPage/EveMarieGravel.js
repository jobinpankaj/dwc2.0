                            ...
                            <div class="contentBx">
                                <div className="clear">
                                    <div className="teamImg">
                                        <img src={EveMarieGravel} class="card-img-top circle" alt="Eve Marie Gravel" />
                                    </div>
                                    <h3 className="mb-2 text-purpal"> Eve-Marie Gravel</h3>
                                    <h6 className="mb-4 degignation">{t('landing.eve-marie.position')}</h6>
                                    <p>{t('landing.eve-marie.p1')}</p>
                                    <p>{t('landing.eve-marie.p2')}</p>
                                    <p>{t('landing.eve-marie.p3')}</p>
                                    <p>{t('landing.eve-marie.p4')}</p>
                                    <p>{t('landing.eve-marie.p5')}</p>
                                </div>
                            </div>
                        </div>
                    </div>
...
export default EveMarieGravelPage;