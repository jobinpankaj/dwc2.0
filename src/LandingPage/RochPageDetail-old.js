                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12"> 
                            <div class="contentBx">
                                ...
                                <div className="teamImg">
                                     <img src={Roch} class="card-img-top circle" alt="Roch"/>
                                </div>
                                <h3 className="mb-2 text-purpal"> ROCH </h3>
                                <h6 className="mb-4 degignation">{t('landing.roch.roch_position')} </h6>
                                <p>{t('landing.roch.p1')}</p>

                                <p>{t('landing.roch.p2')}</p>

                                <p>{t('landing.roch.p3')}</p>

                                <p>{t('landing.roch.p4')}</p>

                                <p>{t('landing.roch.p5')}</p>

                                <p>{t('landing.roch.p6')}</p>
                                </div>
