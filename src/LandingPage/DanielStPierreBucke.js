                            ...
                            <div class="contentBx">
                                <div className="clear">
                                    <div className="teamImg">
                                        <img src={DanielStPierreBucke} class="card-img-top circle" alt="Daniel St Pierre Bucke" />
                                    </div>
                                    <h3 className="mb-2 text-purpal"> Daniel St-Pierre (“Dan”) </h3>
                                    <h6 className="mb-4 degignation">{t('landing.daniel.daniel_position')} </h6>
                                    <p>{t('landing.daniel.p1')}</p>
                                    <p>{t('landing.daniel.p2')}</p>
                                    <p>{t('landing.daniel.p3')}</p>
                                    <p>{t('landing.daniel.p4')}</p>
                                </div>
...
export default DanielStPierreBuckePage;