...
const DistributorTransferDetail = () => {
    ...
    return (
        <div class="container-fluid page-wrap inventory-manage">
            <div class="row height-inherit">
                ...
                <Sidebar showSidebar={showSidebar} updateSidebar={updateSidebar} userType={"distributor"} />
...
export default DistributorTransferDetail;