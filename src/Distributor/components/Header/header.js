...
const Header = ({ title, updateSidebar }) => {
  ...
  const distributorImage = localStorage.getItem("distributorImage");
        ...
        <div className="col-12 col-sm-8 header-right">
          ...
          <div className="profile-option">
            ...
            <div className="dropdown">
              ...
              >
                <img
                  src={distributorImage === "null" ? profile : distributorImage}
                  alt=""
                  width={"40px"}
                  height={"40px"}
              ...
              <ul className="dropdown-menu">
                <li>
                  <a
                    className="dropdown-item"
                    onClick={() => navigate("/distributor/my-account")}
                  >
                    {t("distributor.header.my_account")}
                  </a>
                </li>
                <li>
