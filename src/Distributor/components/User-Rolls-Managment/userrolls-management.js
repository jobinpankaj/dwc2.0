    ...
    <div class="container-fluid page-wrap product-manage">
      <div class="row height-inherit">
        ...
        <div class="col main p-0">
          <Header title="Distributor Management" updateSidebar={updateSidebar} />
                            ...
                            <div className="card-top-filter-box p-3">
                              ...
                              <div class="dropdown right-filter">
                                <button
                                  ...
                                  onClick={() => navigate('/distributor/user-role/add-user-role')}
                                >
                                ...
                                >
                                  <div class="mb-3">
                                    <label class="form-label">
                                      {t("distributor.user_roles.distributor_name")}
                                    </label>
                                    <select className="form-select">
                                      <option value="">{t("distributor.user_roles.choose_supplier")}</option>
                                    </select>
                                  </div>
                                  <div class="mb-3">
                          ...
                          <div className="col">
                            <div className="table-responsive">
                              <table className="table table-striped m-0">
                                <thead>
                                  <tr>
                                    <th>{t("distributor.user_roles.user_id")}</th>
                            ...
                            <div className="card-top-filter-box p-3">
                              ...
                              <div class="dropdown right-filter">
                                <button
                                  type="button"
                                  className="btn btn-purple"
                                  onClick={() => navigate("/distributor/user-role/add-role")}
                                >
...
export default DistributorUsersRoles;
