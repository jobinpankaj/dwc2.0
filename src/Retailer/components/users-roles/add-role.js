...
//       setPermissionError(
//         "Please select atleast one permission to create role."
//       );
...
//       apis
//         .post("retailer/addRetailerRole", bodyData, config)
//         .then((res) => {
...
//     apis
//       .get("/retailer/getPermission", config)
//       .then((res) => {
//         if (res.data.success === true) {
...
//                                 {t("distributor.add_role.role_name")}
//                               </label>
//                               <input
//                                 type="text"
//                                 class="form-control"
//                                 placeholder={t("distributor.add_role.enter_role_name")}
//                                 value={roleName}
//                                 onChange={(e) => {
...
//                                 }}
//                               >
//                                 {t("distributor.add_role.assign_permission")}
//                               </button>
//                               {permissionError !== "" ? (
...
//                       onClick={() => navigate("/retailer/user-role")}
//                     >
//                       {t("distributor.add_role.cancel")}
//                     </button>
//                     <button
//                       type="button"
//                       class="btn btn-purple width-auto"
...
// export default AddRoleRetailer;
