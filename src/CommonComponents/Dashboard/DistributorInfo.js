...
const Info = ({ accessToken = "" }) => {
  ...
  const url = `/GetDistributor_Dashboard`;
  const config = {
    headers: {
          ...
          <div className="row mb-3">
            <div className="col-sm-2 col-sm-dash mb-3 mb-10">
              <div className="card user-card height-100 line1">
                ...
                {t("distributor.dashboard.total_orders")}
                        </label>{" "}
                ...
                <div className="card-body">
                  ...
                  <div className="dash-widget-txt">
                    <p class="mb-0">
                      ...
                      <span class="text-nowrap">
                        <label className="badge bg-white bg-opacity-10 me-1">
                    {t("distributor.dashboard.total_revenue")}
                        </label>{" "}
                ...
                <div className="card-body">
                  ...
                  <div className="dash-widget-txt">
                    <p class="mb-0">
                      ...
                      <span class="text-nowrap">
                        <label className="badge bg-white bg-opacity-10 me-1">
                       {t("distributor.dashboard.invoice_sent")}{" "}
                        </label>{" "}
                      </span>
                    </p>
                  </div>
                ...
                <div className="card-body">
                  ...
                  <div className="dash-widget-txt">
                    <p class="mb-0">
                      ...
                      <span class="text-nowrap">
                        <label className="badge bg-white bg-opacity-10 me-1">
                          {t("distributor.dashboard.retailers")}
                        </label>{" "}
                      </span>
                    </p>
                  </div>
