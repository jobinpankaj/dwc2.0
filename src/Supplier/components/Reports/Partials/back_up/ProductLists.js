    ...
    if (dataKey) {
      ...
      if (newFormData?.length != 0) {
        setFormData((prevData) => ({
          ...
          retailer: newFormData[1]?.retailer_id ?? "",
    ...
    <h5>{values?.company_name} </h5>
                ...
                <Form.Group as={Col} controlId="group">
                  ...
                  <Form.Control.Feedback
                    ...
                    type="invalid"
                  >
                    {t("modal.choose")} {t("modal.is_required")}.
                  </Form.Control.Feedback>
                </Form.Group>
                  <Form.Group as={Col} controlId="order-state">
                    ...
                    >
                      <option value="">{t("modal.choose")}</option>
                      <option value="all">{t("modal.all")}</option>
                      <option value="Pending">{t("modal.pending")}</option>
                      <option value="Approved">{t("modal.approved")}</option>
                      <option value="shipped">{t("modal.shipped")}</option>
                      <option value="delivered">{t("modal.delivered")}</option>
                      <option value="cancelled">{t("modal.cancelled")}</option>
                    </Form.Control>
                    <Form.Control.Feedback
                      className="error-label"
                      type="invalid"
                  ...
                  <Form.Group as={Col} controlId="invoice-state">
                    ...
                    >
                      ...
                      <option value="pending">{t("modal.pending")}</option>
                      <option value="overdue">{t("modal.overdue")}</option>
                      <option value="closed">{t("modal.closed")}</option>
                      <option value="collect">{t("modal.collect")}</option>
                    </Form.Control>
                    <Form.Control.Feedback
                      className="error-label"
                      type="invalid"
