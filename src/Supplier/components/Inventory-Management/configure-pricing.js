...
const ConfigurePricing = () => {
  ...
  // const units = state.product_unit;
  const units = 1;
  ...
  const handleSavePricing = () => {
    ...
    if (
      ...
      apis
        .post("/supplier/pricing/add", bodyData, config)
        .then((res) => {
          if (res.data.success === true) {
            toast.success("Pricing added for the product.", {
              autoClose: 3000,
    ...
    <div class="container-fluid page-wrap inventory-manage">
      <div class="row height-inherit">
        ...
        <div class="col main p-0">
          <Header
            title={t("supplier.inventory_management.config_price.title")}
          />
                  ...
                  <div className="card p-2 p-sm-4  mb-3">
                    <div className="card-body">
                      <h3 className="titleName">
                        {t(
                          "supplier.inventory_management.config_price.header_1"
                        )}
                      </h3>
                      <hr />
                      <div className="row">
                        <div className="col-sm-12 col-xxl-10">
                          <h4 className="d-flex align-items-center gap-2">
                            ...
                            {/* <span class="badge text-bg-red border-bg-red rounded-pill ms-2">
                              DEACTIVATE PRODUCT
                            </span> */}
                          </h4>
