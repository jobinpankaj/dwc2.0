...
const ViewEditDistributorAddress = () => {
      ...
      .then((res) => {
        ...
        if (res.data.success === true) {
          if (res.data.data.user_main_address) {
            ...
            setMainAddress(res.data.data.user_main_address.address_1);
            ...
            setMainPlaceId(res.data.data.user_main_address.place_id);
          }
          ...
          if (res.data.data.user_billing_address) {
            ...
            setBillingAddress(res.data.data.user_billing_address.address_1);
            ...
            setBillingPlaceId(res.data.data.user_billing_address.place_id);
          }
        }
      })
      .catch((error) => console.log(error));
  ...
  const handleSave = (e) => {
    ...
    if (!addressValid) {
      ...
      const bodyData = {
        ...
        billing_place_id: billingPlaceId,
      };
    ...
    <div class="container-fluid page-wrap add-supplier-info">
      <div class="row height-inherit">
        ...
        <div class="col main p-0">
          <Header
            title={t("admin.distributor_management.edit_third.title")}
                ...
                <form>
                                  ...
                                  <div className="row">
                                    ...
                                    <div className="col-sm-6 mb-3 position-relative">
                                      ...
                                      <input
                                        ...
                                        placeholder={t(
                                          "admin.distributor_management.edit_third.state_ph"
                                        )}
                                      />
                                    </div>
                                  </div>
                                  <div className="row">
                                    ...
                                    <div className="col-sm-6 mb-3 position-relative">
                                      ...
                                      <input
                                        ...
                                        placeholder={t(
                                          "admin.distributor_management.edit_third.country_ph"
                                        )}
                                      />
                                    </div>
                                  </div>
                                ...
                                <div className="col-xl-9 col-12">
                                  <div className="row">
                                    ...
                                    <div className="w-100 mb-4 d-flex align-items-center">
                                      ...
                                      />
                                      {t(
                                        "admin.distributor_management.edit_third.same_as"
                                      )}
                                    </div>
                                    <div className="col-sm-6 mb-3">
                                      <label className="form-label">
                  ...
                  <div className="row mt-4">
                    <div className="col">
                      ...
                      >
                        {t(
                          "admin.distributor_management.edit_third.cancel_button"
                        )}
                      </button>
                      <button
                        type="button"
                      ...
                      >
                        {" "}
                        {t(
                          "admin.distributor_management.edit_third.next_button"
                        )}
                      </button>
                    </div>
                  </div>
...
export default ViewEditDistributorAddress;
