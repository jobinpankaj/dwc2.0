...
const AddDistributor = () => {
  ...
  const handleNext = (e) => {
    ...
    if (
      ...
      apis
        .post("/addDistributorUser", formdata, config)
        .then((res) => {
          if (res.data.success === true) {
            ...
            setLoading(false);
            navigate(
              `/distributor-management/add-distributor-general-info/${res.data.data.id}`
            );
          } else {
    ...
    <div class="container-fluid page-wrap add-supplier">
      <div class="row height-inherit">
        ...
        <div class="col main p-0">
          <Header
            title={t("admin.distributor_management.add_first.title")}
                  ...
                  <form>
                                  ...
                                  <div className="col text-center d-flex flex-column justify-content-center align-items-center">
                                    ...
                                    <div className="w-100 text-center">
                                      <div class="form-check form-switch d-inline-flex align-items-center w-auto">
                                        ...
                                        >
                                          {t(
                                            "admin.distributor_management.add_first.enable"
                                          )}
                                        </label>
                                      </div>
                                    </div>
                              ...
                              <div className="card-body">
                                <div className="row">
                                  <div className="form-head w-100">
                                    {t(
                                      "admin.distributor_management.add_first.card_header"
                                    )}
                                  </div>
                                  <div className="col-sm-6 mb-3">
                                    <label className="form-label">
                                      {t(
                                        "admin.distributor_management.add_first.first_name"
                                      )}
                                      <sup>*</sup>
                                    </label>
                                    <input
                                      ...
                                      value={firstName}
                                      placeholder={t(
                                        "admin.distributor_management.add_first.fn_label"
                                      )}
                                  ...
                                  <div className="col-sm-6 mb-3">
                                    <label className="form-label">
                                      {t(
                                        "admin.distributor_management.add_first.last_name"
                                      )}
                                      <sup>*</sup>
                                    </label>
                                    <input
                                      ...
                                      value={lastName}
                                      placeholder={t(
                                        "admin.distributor_management.add_first.ln_label"
                                      )}
                                ...
                                <div className="row">
                                  <div className="col-sm-6 mb-3">
                                    <label className="form-label">
                                      {t(
                                        "admin.distributor_management.add_first.email"
                                      )}
                                      <sup>*</sup>
                                    </label>
                                    <input
                                      ...
                                      value={email}
                                      placeholder={t(
                                        "admin.distributor_management.add_first.email_label"
                                      )}
                                  ...
                                  <div className="col-sm-6 mb-3">
                                    <label className="form-label">
                                      {t(
                                        "admin.distributor_management.add_first.mobile_number"
                                      )}
                                      <sup>*</sup>
                                    </label>
                                    <input
                                      ...
                                      value={mobile}
                                      placeholder={t(
                                        "admin.distributor_management.add_first.mobile_label"
                                      )}
                                ...
                                <div className="row">
                                  <div className="col-sm-6 mb-3">
                                    <label className="form-label">
                                      {t(
                                        "admin.distributor_management.add_first.create_pass"
                                      )}
                                      <sup>*</sup>
                                    </label>
                                    <div className="position-relative">
                                      <input
                                        ...
                                        value={pass1}
                                        placeholder={t(
                                          "admin.distributor_management.add_first.pass1_label"
                                        )}
                                  ...
                                  <div className="col-sm-6 mb-3">
                                    <label className="form-label">
                                      {t(
                                        "admin.distributor_management.add_first.confirm_pass"
                                      )}
                                      <sup>*</sup>
                                    </label>
                                    <div className="position-relative">
                                      <input
                                        ...
                                        value={pass2}
                                        placeholder={t(
                                          "admin.distributor_management.add_first.pass2_label"
                                        )}
                    ...
                    <div className="row mt-4">
                      <div className="col">
                        ...
                        >
                          {t(
                            "admin.distributor_management.add_first.cancel_button"
                          )}
                        </button>
                        <button
                        ...
                        >
                          {t(
                            "admin.distributor_management.add_first.next_button"
                          )}
                        </button>
                      </div>
                    </div>
