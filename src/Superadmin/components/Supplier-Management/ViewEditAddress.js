    ...
    <div class="container-fluid page-wrap add-supplier-info">
      <div class="row height-inherit">
        ...
        <div class="col main p-0">
          <Header
            title={t("admin.supplier_management.edit_third.title")}
                ...
                <form>
                          ...
                          <div className="card shadow-none img-card">
                            <div className="card-body">
                                  ...
                                  <div className="row">
                                    ...
                                    <div className="col-sm-6 mb-3">
                                      ...
                                      <input
                                        ...
                                        value={mainAddress2}
                                        placeholder={t(
                                          "admin.supplier_management.edit_third.address_2_ph"
                                        )}
                                        onChange={(e) =>
                                  ...
                                  <div className="row">
                                    <div className="col-sm-6 mb-3">
                                      ...
                                      <input
                                        ...
                                        value={mainCity}
                                        placeholder={t(
                                          "admin.supplier_management.edit_third.city_ph"
                                        )}
                                        onChange={(e) =>
                                    ...
                                    <div className="col-sm-6 mb-3 position-relative">
                                      ...
                                      <input
                                        ...
                                        placeholder={t(
                                          "admin.supplier_management.edit_third.state_ph"
                                        )}
                                      />
                                    </div>
                                  </div>
                                  <div className="row">
                                    <div className="col-sm-6 mb-3">
                                      ...
                                      <input
                                        ...
                                        placeholder={t(
                                          "admin.supplier_management.edit_third.postal_ph"
                                        )}
                                      />
                                    </div>
                                    ...
                                    <div className="col-sm-6 mb-3 position-relative">
                                      ...
                                      <input
                                        ...
                                        placeholder={t(
                                          "admin.supplier_management.edit_third.country_ph"
                                        )}
                                      />
                                    </div>
                                  </div>
                              ...
                              <div className="w-100 d-flex align-items-start mb-3">
                                ...
                                <p className="m-0">
                                  {t(
                                    "admin.supplier_management.edit_third.same_as"
                                  )}
                                </p>
                              </div>
                              {/* [Billing Info] */}
                                  ...
                                  <div className="row">
                                    ...
                                    <div className="col-sm-6 mb-3">
                                      ...
                                      <input
                                        ...
                                        placeholder={t(
                                          "admin.supplier_management.edit_third.company_ph"
                                        )}
                                      />
                                    </div>
                                    <div className="col-sm-6 mb-3">
                  ...
                  <div className="row mt-4">
                    <div className="col">
                      ...
                      >
                        {t(
                          "admin.supplier_management.edit_third.cancel_button"
                        )}
                      </button>
                      <button
                        type="button"
                      ...
                      >
                        {t("admin.supplier_management.edit_third.next_button")}
                      </button>
                    </div>
                  </div>
                </form>
