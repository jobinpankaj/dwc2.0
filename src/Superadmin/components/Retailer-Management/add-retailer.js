...
const AddRetailer = () => {
  ...
  const handleNext = (e) => {
    ...
    if (
      ...
      apis
        .post("/addRetailerUser", formdata, config)
        .then((res) => {
          if (res.data.success === true) {
            ...
            setLoading(false);
            navigate(
              `/retailer-management/add-retailer-address/${res.data.data.id}`
            );
          } else {
    ...
    <div class="container-fluid page-wrap add-supplier">
      <div class="row height-inherit">
        ...
        <div class="col main p-0">
          <Header
            title={t("admin.retailer_management.add_first.title")}
                  ...
                  <form>
                                  ...
                                  <div className="col text-center d-flex flex-column justify-content-center align-items-center">
                                    ...
                                    <div className="w-100 text-center">
                                      <div class="form-check form-switch d-inline-flex align-items-center w-auto">
                                        ...
                                        >
                                          {t(
                                            "admin.retailer_management.add_first.enable"
                                          )}
                                        </label>
                                      </div>
                                    </div>
                              ...
                              <div className="card-body">
                                <div className="row">
                                  <div className="form-head w-100">
                                    {t(
                                      "admin.retailer_management.add_first.card_header"
                                    )}
                                  </div>
                                  <div className="col-sm-6 mb-3">
                                    <label className="form-label">
                                      {t(
                                        "admin.retailer_management.add_first.first_name"
                                      )}
                                      <sup>*</sup>
                                    </label>
                                    <input
                                      ...
                                      value={firstName}
                                      placeholder={t(
                                        "admin.retailer_management.add_first.fn_label"
                                      )}
                                  ...
                                  <div className="col-sm-6 mb-3">
                                    <label className="form-label">
                                      {t(
                                        "admin.retailer_management.add_first.last_name"
                                      )}
                                      <sup>*</sup>
                                    </label>
                                    <input
                                      ...
                                      value={lastName}
                                      placeholder={t(
                                        "admin.retailer_management.add_first.ln_label"
                                      )}
                                ...
                                <div className="row">
                                  <div className="col-sm-6 mb-3">
                                    <label className="form-label">
                                      {t(
                                        "admin.retailer_management.add_first.email"
                                      )}
                                      <sup>*</sup>
                                    </label>
                                    <input
                                      ...
                                      value={email}
                                      placeholder={t(
                                        "admin.retailer_management.add_first.email_label"
                                      )}
                                  ...
                                  <div className="col-sm-6 mb-3">
                                    <label className="form-label">
                                      {t(
                                        "admin.retailer_management.add_first.mobile_number"
                                      )}
                                      <sup>*</sup>
                                    </label>
                                    <input
                                      ...
                                      value={mobile}
                                      placeholder={t(
                                        "admin.retailer_management.add_first.mobile_label"
                                      )}
                                ...
                                <div className="row">
                                  <div className="col-sm-6 mb-3">
                                    <label className="form-label">
                                      {t(
                                        "admin.retailer_management.add_first.create_pass"
                                      )}
                                      <sup>*</sup>
                                    </label>
                                    <div className="position-relative">
                                      <input
                                        ...
                                        placeholder={t(
                                          "admin.retailer_management.add_first.pass1_label"
                                        )}
                                      />
                                      <span
                                        className={
                                  ...
                                  <div className="col-sm-6 mb-3 position-relative">
                                    <label className="form-label">
                                      {t(
                                        "admin.retailer_management.add_first.confirm_pass"
                                      )}
                                      <sup>*</sup>
                                    </label>
                                    <div className="position-relative">
                                      <input
                                        ...
                                        placeholder={t(
                                          "admin.retailer_management.add_first.pass2_label"
                                        )}
                                      />
                                      <span
                                        className={
                    ...
                    <div className="row mt-4">
                      <div className="col">
                        ...
                        >
                          {t(
                            "admin.retailer_management.add_first.cancel_button"
                          )}
                        </button>
                        <button
                          type="button"
                        ...
                        >
                          {t("admin.retailer_management.add_first.next_button")}
                        </button>
                      </div>
                    </div>
                  </form>
